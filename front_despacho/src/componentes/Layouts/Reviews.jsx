      ...
      <div className="mx-auto text-center ">
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <img
            ...
            src="https://cdn.simpleicons.org/apple/111827"
            alt="Apple"
            width="158"
            height="48"
          />
          ...
          <img
            className="col-span-2 max-h-12 w-full object-contain lg:col-span-1 mx-auto"
            src="https://cdn.simpleicons.org/nvidia/111827"
            alt="NVIDIA"
            width="158"
            height="48"
          />
          <img
            ...
            src="https://cdn.freebiesupply.com/logos/large/2x/logitech-gaming-2-logo-png-transparent.png"
            alt="Logitech"
            width="158"
            height="48"
          />
